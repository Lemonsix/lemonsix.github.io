  ...
  ><defs
    ...
    ><linearGradient
      ...
      ><stop stop-color="#F9A03C" offset="0%" /><stop
        ...
        offset="100%"
      /></linearGradient
    ><linearGradient x1="11.339%" y1="-1.822%" x2="82.496%" y2="92.107%" id="d"
      ><stop stop-color="#F26D58" offset="0%" /><stop
        stop-color="#F9A03C"
        offset="100%"
      /></linearGradient
    ><linearGradient x1="15.844%" y1="3.858%" x2="120.126%" y2="72.38%" id="e"
      ><stop stop-color="#B84E51" offset="0%" /><stop
        stop-color="#F68E48"
        offset="100%"
      /></linearGradient
    ><linearGradient x1="46.984%" y1="23.466%" x2="51.881%" y2="147.391%" id="f"
      ><stop stop-color="#F9A03C" offset="0%" /><stop
        stop-color="#F7974E"
        offset="100%"
      /></linearGradient
